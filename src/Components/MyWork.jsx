...
// import AEIMage from "./public/AE.a58c454d209274086051.jpg"
const works = [
  {
    name: " American Eagle Outfitters e-commerce platform",
    link: "https://ae-frontend-two.vercel.app/",
    tec: "node",
    img: "./AE.a58c454d209274086051.jpg",
    des: `Frontend:used Redux Toolkit for state management and Tailwind CSS for a clean, responsive design, ensuring smooth navigation and a seamless user experience.
                Backend: used nodeJs & express & MongoDB with Mongoose 
         `,
...
export default function MyWork() {
  ...
  if (sort === "fullstack") data = works.filter((item) => item.tec === "node");
  ...
  return (
    <div className="px-10 py-4 bg-slate-100 dark:bg-black">
      ...
      <div className="flex py-2 justify-center mb-10">
        <button
          onClick={(e) => sortValue(e.target.value)}
          value={"all"}
          className="w-32 rounded-lg text-white sm:py-1 bg-blue-600 me-1 px-2"
        >
          All
        </button>
        <button
